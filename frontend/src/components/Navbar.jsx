      ...
      <nav className="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
        ...
        <div className="collapse navbar-collapse" id="navbarCollapse">
          <div className="navbar-nav ms-auto py-0 pe-4">
            ...
            <a href="/halloffame" className="nav-item nav-link" style={{ fontFamily: 'Metal Mania', fontSize: 20 }}>
              HOF
            </a>
            <a href="menu.html" className="nav-item nav-link" style={{ fontFamily: 'Metal Mania', fontSize: 20 }}>
              Points Table
            ...
            <a href="/aboutus" className="nav-item nav-link" style={{ fontFamily: 'Metal Mania', fontSize: 20 }}>
              About Us
            </a>
          </div>
